...
public class final6 {
    ...
    private static void deleteResource(Scanner scanner) {
        System.out.println("Delete resource by:");
        System.out.println("1. Resource ID");
        System.out.println("2. All resources");
        System.out.print("Choose an option: ");
        ...
        switch (deleteChoice) {
            case 1:
                deleteResourceById(scanner);
                break;
            case 2:
                deleteAllResources(scanner);
                break;
            default:
    ...
    private static void deleteResourceById(Scanner scanner) {
    ...
    private static void deleteAllResources(Scanner scanner) {
        System.out.print("Are you sure you want to delete all resources? (yes/no): ");
        ...
        if (confirmation.equalsIgnoreCase("yes")) {
            ...
            try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
                ...
                System.out.println(rowsDeleted + " resources deleted successfully!");
            } catch (SQLException e) {
                e.printStackTrace();
                System.out.println("Failed to delete resources!");
            }
        } else {
